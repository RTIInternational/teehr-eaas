...
# TEEHR Iceberg REST Catalog Docker Build and Push Script
set -e

# Configuration
AWS_REGION=${AWS_REGION:-us-east-2}
AWS_ACCOUNT_ID=$(aws sts get-caller-identity --query Account --output text)
REPOSITORY_NAME="dev-teehr-sys/iceberg-rest-catalog"
IMAGE_TAG=${IMAGE_TAG:-latest}

# Full ECR repository URI
ECR_URI="${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/${REPOSITORY_NAME}"

echo "Building and pushing Iceberg REST Catalog image..."
